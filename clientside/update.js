...
const updateOptions = {
    gitRepo: "servermanager", // [Required] Your Repo Name
    gitUsername: "iguessiplay",  // [Required] Your GitHub Username.

    appName: "servermanager", //[Required] The Name of the app archive and the app folder.
    appExecutableName: "app.js", //[Required] The Executable of the Application to be Run after updating.
